...
<div id="screen">
	<div id="cube" class='cube'>
		<img id="1" src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (18).jpg" class='face' data-transform="translateZ(-400px)" style="outline:none !important">
		<img id="2" src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (63).jpg" class='face' data-transform="rotateY(90deg) translateZ(-600px)">
		<img id="3" src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (17).jpg"  class='face' data-transform="rotateY(-90deg) translateZ(-600px)">
		<img id="4" src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (62).jpg" class='face' data-transform="rotateY(180deg) translateZ(-600px)">
		<img id="5" src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (45).jpg" class='face' data-transform="rotateX(90deg) translateZ(-500px)">
        <img id="6" src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (61).jpg"  class='face' data-transform="rotateX(-90deg) translateZ(-500px)">
        
		<img src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (42).jpg" class='face button' alt="7" data-transform="translateY(-80px) translateZ(-340px) scale(0.5)">
		<img src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (63).jpg" class='face button' alt="2" data-transform="translateX(-200px) translateY(-80px) translateZ(-340px) scale(0.5)">
		<img src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (17).jpg" class='face button' alt="3" data-transform="translateX(200px) translateY(-80px) translateZ(-340px) scale(0.5)">
		<img src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (62).jpg" class='face button' alt="4" data-transform="translateY(80px) translateZ(-340px) scale(0.5)">
		<img src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (45).jpg" class='face button' alt="5" data-transform="translateX(-200px) translateY(80px) translateZ(-340px) scale(0.5)">
		<img src="../IMAGES/ALBUM GAEL/PICT'ART ALBUM FINAL/picture (61).jpg" class='face button' alt="6" data-transform="translateX(200px) translateY(80px) translateZ(-340px) scale(0.5)">
	</div>
</div>
